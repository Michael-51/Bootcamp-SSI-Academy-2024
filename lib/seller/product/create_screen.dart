...
class IndexProductScreen extends StatefulWidget {
  const IndexProductScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Container(
          margin: const EdgeInsets.symmetric(vertical: 8), // Margin atas dan bawah untuk estetika
          ...
          TextButton(
            onPressed: () async { // Tambahkan async di sini
              ...
              if (success) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Produk gagal terhapus')),
                );
              }
            },
